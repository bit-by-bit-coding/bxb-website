...
<div class="content">
    ...
    <div class="section">
        <h2>// Details</h2>
        <div>
            <div id="warning"><strong>Registration is OPEN. We are holding off on collecting payment until we know more
                    about Oregon’s plans to reopen, likely in June. If the program is online for health reasons, it will
                    be free and any payment accepted at that time will be fully refunded. Click a <a href="covid.php">here</a> to learn more about
                    precautions we're taking against Covid-19.</strong></div>
